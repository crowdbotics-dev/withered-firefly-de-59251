...
## Project Structure
    ...
    ├── withered_firefly_de_59251  # Django project configurations
...
1. Clone this repo and `cd withered_firefly_de_59251`
...
2. Clone this repo and `cd withered_firefly_de_59251`
